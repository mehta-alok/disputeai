...
const DISPUTE_COMPANIES = {
  ...
  VERIFI: {
    ...
    twoWaySync: true,
    logo: '💳',
    portalUrl: 'https://my.verifi.com/user/framework/session/login/',
    features: [
      'Visa CDRN Alerts',
  ...
  ETHOCA: {
    ...
    twoWaySync: true,
    logo: '🔴',
    portalUrl: 'https://www.ethocaweb.com/portal/login.html',
    features: [
      'Consumer Clarity',
      'Alerts Service',
      'Eliminator',
  ...
  CHASE_MERCHANT: {
    ...
    twoWaySync: true,
    logo: '🏦',
    portalUrl: 'https://secure.paymentech.com/portal',
  ...
  ELAVON: {
    ...
    twoWaySync: true,
    logo: '🔷',
    portalUrl: 'https://www.elavonconnect.com/ui/',
  ...
  FISERV: {
    ...
    twoWaySync: true,
    logo: '🟢',
    portalUrl: 'https://www.businesstrack.com/',
  ...
  GLOBAL_PAYMENTS: {
    ...
    twoWaySync: true,
    logo: '🌐',
    portalUrl: 'https://myaccount.globalpayments.com/',
  ...
  TSYS: {
    ...
    twoWaySync: true,
    logo: '🔶',
    portalUrl: 'https://accounts.tsys.com/',
  ...
  KOUNT: {
    ...
    twoWaySync: true,
    logo: '🛡️',
    portalUrl: 'https://app.kount.com/login',
