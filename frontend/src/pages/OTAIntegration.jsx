...
const OTA_PROVIDERS = [
  ...
  },
  {
    ...
    apiVersion: 'v1.3',
    connectionType: 'API Key',
    portalUrl: 'https://pricelinepartnersolutions.com/',
    webhookSupport: false,
    twoWaySync: true,
    requiredConfig: ['apiKey', 'propertyId'],
  },
          ...
          <div className="bg-gray-50 rounded-lg border border-gray-200 p-4">
            ...
            <div className="space-y-2">
              {[
                ...
                { time: '2 hrs ago', event: 'Rate discrepancy detected: Engine vs PMS', type: 'anomaly', detail: 'RES-78567 · OTA rate $189/night vs PMS rate $212/night' },
              ].map((item, i) => {
                const typeColors = {
                  dispute: 'bg-red-500',
                  fraud: 'bg-amber-500',
